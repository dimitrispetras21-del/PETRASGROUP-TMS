...
--
-- ΕΚΤΕΛΕΣΤΗΚΕ 21/9 βράδυ (owner) μαζί με το Worker deploy — επαληθεύτηκε 22/9 πρωί από
-- δύο sessions: pg_trigger = 2 (orders + national_orders), ΜΕΤΑ-SELECT invoiced 2 / χωρίς
-- αριθμό 2 (οι γραμμές της 21/8, όπως αναμενόταν), invoiceMarkError στο ζωντανό bundle.
-- (Αρχικά: εγκεκριμένη 21/9, σειρά Worker deploy (422) → 043 → push front end.)
