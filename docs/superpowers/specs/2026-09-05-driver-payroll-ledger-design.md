...
(πρότυπο: `ΑΙΜΙΛΙΟΣ.xlsx`, 168 γραμμές, 2024–2026).
...
```
Επαλήθευση στο πρότυπο: 168 γραμμές, χρονολογικά ταξινομημένες → **354,76 €**,
...
- `ct_cost_lines.category` CHECK: αφαιρούνται `driver_pay`, `cash_m`. Η μία
  υπάρχουσα γραμμή `cash_m` (id 3, 50 €, RT-1014, Banas Antonis) μεταφέρεται
...
οδηγό, διάταξη `ΑΙΜΙΛΙΟΣ.xlsx`: κεφαλίδα γρ. 3, στήλες B Α/Α · C ημ/νία
...
```
Για τον Αιμίλιο: 168 γραμμές, 354,76.
...
Έλεγχοι στο repo: `tests/critics` — (α) SQL: υπόλοιπο Αιμίλιου = 354,76 και
...
4. Εισαγωγή: dry run ΑΙΜΙΛΙΟΣ → 354,76 → commit → υπόλοιπα αρχεία Drive.
