...
**Κλειστά: 63 / 230** — 36 live, **16 σε κλάδο** (`fix/phase2-hierarchy-design`).
...
| ✅ **Φάση 2 · Δ+Ε** — live | **11** | `ME-3` `WN-4` `DR-4` `OI-4` `WN-7` `MS-3` `WS-3` `SH-11` `DO-8` `DO-9` · `CL-4`/`TR-6` (a11y entity.js) |
