...
_Ενημέρωση: 4/8/2026. **Ένα σημείο, όχι στήλη σε 230 γραμμές** — μια στήλη θα
...
**Κλειστά: 36 / 230** — εκ των οποίων **22 live**, 14 σε κλάδο.

| Κατάσταση | Πλήθος | Κωδικοί |
|---|---:|---|
| ✅ **Live** — merged `f592302`, deployed & επαληθευμένο 4/8 | **22** | `SH-1` `SH-4` `SH-5` `SH-12` · `D-1` `D-2` · `OI-1` · `PF-1` · `MD-1` · `ME-1` `ME-2` · `AD-1` · `LG-1` `LG-3` `LG-5` · `WI-1` · `WN-2` · `CE-2` · `IN-2` · `LO-4` · `WS-2` `ON-5` · _(+ `--text-dim` → AA, `_CROSS_CUTTING` §4)_ |
| 🔵 **Σε κλάδο** `fix/phase1-metrics-greek` — **δεν το βλέπει χρήστης** | **14** | `MA-1` `MA-2` `MA-6` · `DR-1` `WI-3` `DO-1` `ME-4` `IN-5` `OI-3` `ON-3` · `PP-2` `CO-1` `SH-9` `MT-4` |
...
**P0: ~14 από 38 κλειστά** (12 live, 2 σε κλάδο).
