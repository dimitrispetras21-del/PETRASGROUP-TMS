...
| ✅ **Φάση 7 Δ+Ε — live 8/8 βράδυ** | **7** | `LO-7` (18 πραγματικά κουμπιά, live) · `WI-5` `WN-6` (2 strips→button, 5 κάρτες role+tabindex, 5 ctx→button· 2 ψευδοθετικά guards) · `SH-2` `MA-3` (**P0 αναπαραγμένο και διορθωμένο**: guards σε 7 async renders· το ίδιο race test που απέτυχε, πέρασε) · `PN-1` (μήνυμα+επιστροφή αντί «Missing orderId») · z-index 17→6 tokens + radius 13→κλίμακα (εκτός αρίθμησης, live) |
...
| ⬜ **Ανοιχτά** | **79** | **68 επαληθευμένα** (+6 που επιβεβαίωσε το Ε: `LO-2` `LO-3` `LO-5` `PA-4` `ON-7` `SH-3` — ήταν ήδη στη λίστα) · οι «18 ανεπαλήθευτοι» έγιναν 5: `PN-4` `PN-5` `LG-6` (68%, όχι 78) `PP-3` `PP-4` + `PU-4/5/6` (άλλο repo — καταγεγραμμένα μόνο)· το `PN-3` είναι ΣΚΟΠΙΜΟ (έγγραφο εκτύπωσης, όχι οθόνη)· το `PN-2` βελτιώθηκε (κοινό κέλυφος weekly) (ζωντανά σε owner session — και οι 34 διαδρομές — ή στον κώδικα/config) · **18 μη επαληθευμένα**: `MA-3` `SH-2` `SH-3` (races/μετρήσεις πολλών σελίδων) · `ON-7` · `PP-3` `PP-4` · `PN-1`…`PN-5` (print.html ροές) · `PU-4` `PU-5` `PU-6` (εσωτερικά του iframe — άλλο repo) · `LG-6` · `LO-2` `LO-5` `PA-4` (τα probes δεν τα ξαναβρήκαν — ίσως άλλαξαν, θέλουν μάτι) |

### Πόσο σίγουρα είναι τα «ανοιχτά» — επικαιροποίηση 8/8/2026

_Ο προηγούμενος υποπίνακας (11 επαληθευμένα / 122 μη επαληθευμένα) ήταν
στιγμιότυπο της 6/8 ΠΡΩΙ, πριν το ζωντανό πέρασμα — και αντέφασκε με τον
κύριο πίνακα (δήλωνε το `PP-1` «επαληθευμένο ανοιχτό» ενώ ο κύριος το είχε
❎). Αντικαταστάθηκε· η μόνη έγκυρη κατηγοριοποίηση είναι του περάσματος:_

| Βεβαιότητα | Πλήθος | Πώς |
|---|---:|---|
| ⬜ **Επαληθευμένα ανοιχτά** | **78** | με μάτι στο παραγωγικό (Φ5, και οι 34 διαδρομές) ή στον κώδικα/config· μείον τα 7 που έκλεισε η Φ6 |
| ⬜ Μη επαληθευμένα | **18** | `MA-3` `SH-2` `SH-3` · `ON-7` · `PP-3` `PP-4` · `PN-1`…`PN-5` · `PU-4` `PU-5` `PU-6` (άλλο repo) · `LG-6` · `LO-2` `LO-5` `PA-4` — ενότητα Ε της Φάσης 7 |

**Άθροισμα 8/8 νύχτα: 131+7 = 138 live (59%) · ❎ 2 · 👤 9 · ⚙️ 5 · ⬜ 79
→ 233** ✓
...
| Ενότητα Γ — τα 18 ανεπαλήθευτα | 3 | PN/MA-3/SH-2/SH-3/LO/LG-6/PP/PU |
