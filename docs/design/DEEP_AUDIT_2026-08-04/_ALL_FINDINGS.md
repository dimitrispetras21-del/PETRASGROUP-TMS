...
**Κλειστά: 52 / 230** — 36 live, **16 σε κλάδο** (`fix/phase2-hierarchy-design`).

| ✅ Φάση 1 + Κύμα 1 — live | **36** | βλ. πίνακα |
| 🔵 **Φάση 2** — κλάδος `fix/phase2-hierarchy-design` | **16** | `MD-2` `MD-3` `MD-5` · `MR-1` `MR-3` `MR-4` `MR-5` `MR-6` · `DR-2` `DR-6` · `DO-2` `DO-3` · `WI-4` `WI-7` `WI-8` · `MA-5` |
