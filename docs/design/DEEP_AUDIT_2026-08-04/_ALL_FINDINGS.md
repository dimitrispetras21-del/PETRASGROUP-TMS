...
_Ενημέρωση: 5/8/2026._

_Διόρθωση 5/8/2026: το μπλοκ έγραφε τα 14 ευρήματα της Φάσης 1 ως «σε
κλάδο, δεν το βλέπει χρήστης». Έγιναν merge (`b164297`) και deploy στις
10:40 της 5/8 και επαληθεύτηκαν ζωντανά — είναι **live**._

_Αρχική σημείωση: **Ένα σημείο, όχι στήλη σε 230 γραμμές** — μια στήλη θα
σήμαινε ξαναγράψιμο όλου του αρχείου σε κάθε PR και θα έπαυε να ενημερώνεται
μέσα σε δύο εβδομάδες. Πρόσθεσε τον κωδικό στη σωστή γραμμή._

**Κλειστά: 68 / 230** — 36 live, **16 σε κλάδο** (`fix/phase2-hierarchy-design`).

| ✅ Φάση 1 + Κύμα 1 — live | **36** | βλ. πίνακα |
| ✅ **Φάση 2 · Α+Β+Γ** — live `3816b36` | **16** | `MD-2` `MD-3` `MD-5` · `MR-1` `MR-3` `MR-4` `MR-5` `MR-6` · `DR-2` `DR-6` · `DO-2` `DO-3` · `WI-4` `WI-7` `WI-8` · `MA-5` |
| ✅ **Φάση 2 · Δ+Ε** — live | **16** | `ME-3` `WN-4` `DR-4` `OI-4` `WN-7` `MS-3` `WS-3` `SH-11` `DO-8` `DO-9` `SH-7` · `CL-4`/`TR-6` (a11y entity.js) · 44px στόχοι · `OI-2`/`ON-2` (υπήρχαν ήδη) |

| Κατάσταση | Πλήθος | Κωδικοί |
|---|---:|---|
| ✅ **Live** — Κύμα 1, merged `f592302`, επαληθευμένο 4/8 | **22** | `SH-1` `SH-4` `SH-5` `SH-12` · `D-1` `D-2` · `OI-1` · `PF-1` · `MD-1` · `ME-1` `ME-2` · `AD-1` · `LG-1` `LG-3` `LG-5` · `WI-1` · `WN-2` · `CE-2` · `IN-2` · `LO-4` · `WS-2` `ON-5` · _(+ `--text-dim` → AA, `_CROSS_CUTTING` §4)_ |
| ✅ **Live** — Φάση 1, merged `b164297`, επαληθευμένο 5/8 | **14** | `MA-1` `MA-2` `MA-6` · `DR-1` `WI-3` `DO-1` `ME-4` `IN-5` `OI-3` `ON-3` · `PP-2` `CO-1` `SH-9` `MT-4` |
| 👤 **Μπλοκαρισμένα στον owner** | 10 | `TL-1` `WS-1` `LO-1` `TR-1` (καταχώρηση) · `MS-1` `MT-1` `ML-1` (χρειάζονται και τη γέφυρα `MR-2`) · `ON-1` (διερεύνηση) · `AT-5` (απόφαση για τους demo λογαριασμούς) |
| ⚙️ **Μπλοκαρισμένα σε backend** | 5 | `PU-1` `PU-2` `PU-3` (PAT petras-assign) · `CO-2` (ο πίνακας `TRIP_COSTS` δίνει 404) · `AT-1` (το ίχνος σταμάτησε 28/7) |
| ⬜ Ανοιχτά | 165 | τα υπόλοιπα |

**P0: ~14 από 38 κλειστά**, όλα live.
