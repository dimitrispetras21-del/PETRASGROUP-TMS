...
| ⬜ **Ανοιχτά** | **78** | **71 επαληθευμένα** (πέρασμα Φ5 + Ε της Φ7) · **4 ανεπαλήθευτα**: `PN-4` `PN-5` `PP-3` `PP-4` · **3 άλλο repo** (petras-assign, δεν ελέγχονται από εδώ): `PU-4` `PU-5` `PU-6` |
...
**ΤΡΕΧΟΝ ΑΘΡΟΙΣΜΑ (9/8/2026): 137 live (59%) · ❎ 3 · 👤 10 · ⚙️ 5 ·
⬜ 78 → 233** ✓
