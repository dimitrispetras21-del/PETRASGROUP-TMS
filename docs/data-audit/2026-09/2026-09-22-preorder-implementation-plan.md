...
> **ΑΝΑΒΛΗΘΗΚΕ (owner 22/9 απόγευμα):** «αφήνουμε την αλλαγή design του Weekly, θα το κάνουμε αργότερα» — το pre-order είναι
> δεμένο με το Weekly + Figma, άρα παγώνει μαζί του. Figma 706/707/709:1011 έτοιμα, σχέδιο υλοποίησης έτοιμο
> (`2026-09-22-preorder-implementation-plan.md`), τίποτα σε κώδικα. Ξεκινά με νέο go του owner. Η ενοποίηση λιστών (2β-b)
> ΔΕΝ περιμένει πια το feat/preorder.
