...
ξεμπλόκαρε 21→22/9· audit pl_movements: 4 create, 2 update), +3 νέες (295, 296, 364). Α:Β από 47+13 → 48+15.

## Τι κάνει η Αλεξία (Ισοζύγιο Παλετών)

- **A_confirm (48 στάσεις):** υπάρχει ήδη εκκρεμής κίνηση LOADING → μόνο **Επιβεβαίωση** στο Ισοζύγιο. Χωρίς upload.
- **B_create_then_confirm (17 στάσεις):** καμία κίνηση LOADING στη στάση → πρώτα «+ κίνηση», μετά επιβεβαίωση.
- Κάθε επιβεβαίωση ξεμπλοκάρει την παραγγελία στην Τιμολόγηση αυτόματα (η πύλη διαβάζει confirmed LOADING ανά στάση).

Σειρά: πρώτα όλα τα A (γρήγορα), μετά τα B. Στόχος ως Παρασκευή 25/9: 0 στην καρτέλα «Μπλοκαρισμένες» της Τιμολόγησης.
