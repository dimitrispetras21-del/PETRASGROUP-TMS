...
Σύνταξη 22/9/2026 · **Κατάσταση: DRAFT — τίποτα δεν εφαρμόστηκε. Ο owner αποφασίζει και εκτελεί.** Η αιτιολόγηση του P1 δόθηκε στον owner εκτός repo (το repo είναι δημόσιο)· εδώ μόνο η γενική διατύπωση: **τα invocation logs του Worker περιέχουν το πλήρες αίτημα, μαζί με headers που δεν πρέπει να διαβάζονται από τρίτους.**
