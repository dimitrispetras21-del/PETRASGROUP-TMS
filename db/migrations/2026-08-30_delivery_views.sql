...
-- ΚΑΤΑΣΤΑΣΗ: ΕΚΤΕΛΕΣΤΗΚΕ 30/8/2026 — βλ. επαλήθευση στο τέλος του αρχείου.
-- ============================================================================
...
-- ΕΚΤΕΛΕΣΤΗΚΕ 30/8/2026 από τον owner. Πραγματική έξοδος:
--   ομάδα        γραμμές  κριμένα  άκριτα  χωρίς_pct
--   οδηγοί           19       54       4       0
--   πελάτες          20       89      10       1
--   συνεργάτες        8       20       0       0
--
-- Το «1» στους πελάτες ΕΙΝΑΙ ΣΩΣΤΟ και επαληθεύτηκε: πελάτης με ΜΙΑ μόνο
-- παραγγελία που δεν έχει σημανθεί ακόμη ως παραδομένη — judged=0, άρα
-- pct=NULL. Η καρτέλα του δείχνει «—». Το 0% θα έλεγε «όλες οι παραδόσεις
-- απέτυχαν», που είναι ψέμα (κανόνας #3).
--
-- Απόκλιση από τα παραπάνω = κάτι πάει στραβά. ΜΗΝ το αγνοήσεις.
--
